<template>
  ...
  <div
    ...
    :style="`background: ${store.getPlayerData.pic ? `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${store.getPlayerData.pic}) center / cover no-repeat` : 'rgba(0, 0, 0, 0.4)'}; color: #efefef`"
>
